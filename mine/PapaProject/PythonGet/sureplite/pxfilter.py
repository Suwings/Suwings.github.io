...
if "__main__" == __name__:
    parser = XssHtml()
    parser.feed("""
    <img src="javascript:alert(1);" height="1000px" width="1000px" style="jsasa">
    <div><p class="aaa"><img src=1 onerror=alert(/xss/)></p><div class="left">
        ...
        <embed src='javascript:alert(/hehe/)' allowscriptaccess=always /></div><p>aaa</p>""")
    parser.close()
